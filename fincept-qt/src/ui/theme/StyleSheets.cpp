...
QString equity_trading_styles() {
    ...
    return QString(
               ...
               "#eqBrandBadge { background: %16; color: %4; border: 1px solid %10; "
               ...
               "  border-bottom: 2px solid transparent; padding: 4px 0; "
               "  font-size: 12px; font-weight: 700; }"
               "#eqBuyTab:hover { color: %11; }"
               "#eqBuyTab[active=\"true\"] { color: %11; border-bottom-color: %11; }"
               "#eqSellTab { background: transparent; color: %6; border: none; "
               "  border-bottom: 2px solid transparent; padding: 4px 0; "
               "  font-size: 12px; font-weight: 700; }"
               "#eqSellTab:hover { color: %15; }"
               "#eqSellTab[active=\"true\"] { color: %15; border-bottom-color: %15; }"
               ...
               "#eqBuySubmit { background: %18; color: %11; "
               "  border: 1px solid %20; padding: 8px; font-weight: 700; font-size: 13px; }"
               "#eqBuySubmit:hover { background: %11; color: %4; }"
               "#eqSellSubmit { background: %17; color: %15; "
               "  border: 1px solid %19; padding: 8px; font-weight: 700; font-size: 13px; }"
               "#eqSellSubmit:hover { background: %15; color: %1; }"
