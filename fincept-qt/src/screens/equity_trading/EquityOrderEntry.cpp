...
EquityOrderEntry::EquityOrderEntry(QWidget* parent) : QWidget(parent) {
    ...
    auto* title = new QLabel(QString::fromUtf8("下单面板"));
    title->setObjectName("eqOeTitle");
    h_layout->addWidget(title);
    h_layout->addStretch();

    mode_label_ = new QLabel(QString::fromUtf8("模拟"));
    ...
    buy_tab_ = new QPushButton(QString::fromUtf8("买入"));
    ...
    sell_tab_ = new QPushButton(QString::fromUtf8("卖出"));
    ...
    // Product type
    auto* prod_lbl = new QLabel(QString::fromUtf8("交易类型"));
    ...
    product_combo_->addItems({QString::fromUtf8("日内交易"), QString::fromUtf8("普通买卖"), QString::fromUtf8("融资融券")});
    product_combo_->setFixedHeight(26);
    form->addWidget(product_combo_);

    // Exchange
    auto* exch_lbl = new QLabel(QString::fromUtf8("交易所"));
    ...
    // Market price
    market_price_label_ = new QLabel(QString::fromUtf8("现价：--"));
    ...
    // Trigger/Stop price
    auto* stop_lbl = new QLabel(QString::fromUtf8("触发价"));
    ...
    stop_price_edit_->setPlaceholderText(QString::fromUtf8("触发价"));
    stop_price_edit_->setEnabled(false);
    stop_price_edit_->setFixedHeight(26);
    form->addWidget(stop_price_edit_);

    // Advanced toggle
    advanced_toggle_ = new QPushButton(QString::fromUtf8("+ 高级"));
    ...
    tp_edit_->setPlaceholderText(QString::fromUtf8("止盈价"));
    ...
    connect(advanced_toggle_, &QPushButton::clicked, this, [this]() {
        ...
        advanced_toggle_->setText(show ? QString::fromUtf8("- 高级") : QString::fromUtf8("+ 高级"));
    });

    // Cost preview
    cost_label_ = new QLabel(QString::fromUtf8("预估：--"));
    ...
    submit_btn_ = new QPushButton(QString::fromUtf8("买入 600519"));
    ...
    broadcast_btn_->setToolTip(QString::fromUtf8("将这笔订单同步发送到多个账户"));
    ...
    connect(broadcast_btn_, &QPushButton::clicked, this, [this]() {
        ...
        if (qty <= 0) {
            status_label_->setText(QString::fromUtf8("请输入有效数量"));
...
void EquityOrderEntry::configure_for_broker(const trading::BrokerProfile& profile) {
    ...
    brokerage_label_->setText(profile.brokerage_info.isEmpty() ? "" : QString::fromUtf8("费用：%1").arg(profile.brokerage_info));
...
void EquityOrderEntry::set_buy_side(bool is_buy) {
    ...
    const QString label = QString("%1 %2").arg(is_buy ? QString::fromUtf8("买入") : QString::fromUtf8("卖出"), current_symbol_);
...
void EquityOrderEntry::set_current_price(double price) {
    ...
    market_price_label_->setText(QString::fromUtf8("现价：%1%2").arg(currency_symbol(current_currency_)).arg(price, 0, 'f', 2));
    update_cost_preview();
}

void EquityOrderEntry::set_mode(bool is_paper) {
    is_paper_ = is_paper;
    mode_label_->setText(is_paper ? QString::fromUtf8("模拟") : QString::fromUtf8("实盘"));
...
void EquityOrderEntry::set_symbol(const QString& symbol) {
    ...
    submit_btn_->setText(QString("%1 %2").arg(is_buy_side_ ? QString::fromUtf8("买入") : QString::fromUtf8("卖出"), symbol));
}
...
void EquityOrderEntry::update_cost_preview() {
    ...
    if (qty > 0 && price > 0)
        cost_label_->setText(QString::fromUtf8("预估：%1%2").arg(sym).arg(qty * price, 0, 'f', 2));
    else
        cost_label_->setText(QString::fromUtf8("预估：--"));
}
